...
#'
#' @param iteration Integer, number of iterations for nattempts rewiring attempts.
...
#' @param sourceIn Vector, sequence of source nodes' in-degree.
...
#'
rewire_directed_cpp <- function(iteration, nattempts, targetNode, sourceOut, sourceIn, targetOut, targetIn, index_s, index_t, eta, rewire_history) {
    .Call(`_wdnet_rewire_directed_cpp`, iteration, nattempts, targetNode, sourceOut, sourceIn, targetOut, targetIn, index_s, index_t, eta, rewire_history)
}
...
#'
rewire_undirected_cpp <- function(iteration, nattempts, node1, node2, degree1, degree2, index1, index2, e, rewire_history) {
    .Call(`_wdnet_rewire_undirected_cpp`, iteration, nattempts, node1, node2, degree1, degree2, index1, index2, e, rewire_history)
}
