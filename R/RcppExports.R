...
#' @return Sampled node.
sampleNode_naive_cpp <- function(tnode, sumstrength, strength, delta) {
    .Call(`_wdnet_sampleNode_naive_cpp`, tnode, sumstrength, strength, delta)
}
...
rpanet_naive_cpp <- function(nstep, control, m, w, outstrength, instrength, sumstrength, nnode) {
    .Call(`_wdnet_rpanet_naive_cpp`, nstep, control, m, w, outstrength, instrength, sumstrength, nnode)
}
