...
#'
#' @param edgelist A two-column matrix, each row represents a directed
#'   edge from the first column to the second column.
#' @param eta A matrix generated by
...
#' @param eta An matrix generated by
...
#'   result). For each rewiring attempt, two rows are sampled from the \code{edgelist},
#'   for example Edge1:\{v_1, v_2\} and Edge2:\{v_3, v_4\}, the function try to
#'   rewire the sampled edges as \{v_1, v_4\}, \{v_3, v_2\} (rewire type 1) or
#'   \{v_1, v_3\}, \{v_2, v_4\} (rewire type 2) with probability 1/2.
#'
#' @keywords internal
#'
...
#' values between -1 and 1 via degree preserving rewiring. This function
#' computes the range of assortativity coefficients that can be achieved through
#' degree preserving rewiring. The algorithm is designed for unweighted
#' networks.
#'
