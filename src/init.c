...
/* .Call calls */
extern SEXP _wdnet_directed_rewire_cpp(SEXP, SEXP, SEXP, SEXP, SEXP);
...
extern SEXP _wdnet_undirected_rewire_cpp(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_wdnet_directed_rewire_cpp",   (DL_FUNC) &_wdnet_directed_rewire_cpp,   5},
    ...
    {"_wdnet_undirected_rewire_cpp", (DL_FUNC) &_wdnet_undirected_rewire_cpp, 6},
    {NULL, NULL, 0}
};
